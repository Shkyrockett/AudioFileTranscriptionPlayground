    ...
    : Form
{
    ...
    private void LoopBasedTranscriptionMethod()
    {
        ...
        if (extension.Equals(".wav", StringComparison.OrdinalIgnoreCase))
        {
            ...
            var text = GetText(file).ToString();
        ...
        else if (extension.Equals(".mp3", StringComparison.OrdinalIgnoreCase))
        {
            ...
            var text = GetText(newFile).ToString();
    ...
    private static StringBuilder GetText(string wavFile)
    {
        ...
        while (completed)
        {
            try
            {
                ...
                //var time = recognizer.RecognizerAudioPosition;
    ...
    /// </summary>
    /// <param name="wavFile"></param>
    private void StartRecognition(string wavFile)
    {
        using SpeechRecognitionEngine recognizer = new();
        // Create and load a grammar.  
        Grammar dictation = new DictationGrammar { Name = "Dictation Grammar" };
        ...
        while (!completed)
        {
            try
            {
                ...
                //var time = recognizer.AudioPosition;
                //var time2 = recognizer.RecognizerAudioPosition;
                //if (progressBar.InvokeRequired)
                //{
                //    Invoke((MethodInvoker)(() => progressBar.Value = time.Seconds));
                //}
                //else
                //{
                //    progressBar.Value = time.Seconds;
                //}
            }
            catch (Exception)
            {
    ...
    private void Recognizer_SpeechRecognized(object sender, SpeechRecognizedEventArgs e)
    {
        ...
        {
            //var audioTime = e.Result.Audio.AudioPosition;
            //var audioDuration = e.Result.Audio.Duration;
            //if (progressBar.InvokeRequired)
            //{
            //    Invoke((MethodInvoker)(() => progressBar.Style = ProgressBarStyle.Continuous));
            //    Invoke((MethodInvoker)(() => progressBar.Maximum = audioDuration.Seconds));
            //    Invoke((MethodInvoker)(() => progressBar.Value = audioTime.Seconds));
            //}
            //else
            //{
            //    progressBar.Style = ProgressBarStyle.Continuous;
            //    progressBar.Maximum = audioDuration.Seconds;
            //    progressBar.Value = audioTime.Seconds;
            //}
            if (textBoxTranscript.InvokeRequired)
            {
