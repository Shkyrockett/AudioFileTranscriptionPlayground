        ...
        : Form
    {
        ...
        private void NewMethod()
        {
            ...
            if (extension.Equals(".wav", StringComparison.OrdinalIgnoreCase))
            {
                ...
                var text = GetText(recognizer).ToString();
            ...
            SkipConversion:
                ...
                recognizer.SetInputToWaveFile(newFile);
                var text = GetText(recognizer).ToString();
        ...
        private static StringBuilder GetText(SpeechRecognitionEngine recognizer)
        {
        ...
        //    recognizer.SetInputToWaveFile(textBoxFile.Text);
        ...
        ///// <summary>
        ///// Recognizer_S the speech recognized.
        ///// </summary>
        ///// <param name="sender">The sender.</param>
        ///// <param name="e">The e.</param>
        ...
        ///// <summary>
        ///// Recognizer_S the recognize completed.
        ///// </summary>
        ///// <param name="sender">The sender.</param>
        ///// <param name="e">The e.</param>
